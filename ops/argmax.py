...
@triton.jit
def kernel0(
    in_ptr0, out_ptr0, xnumel, rnumel, XBLOCK: tl.constexpr, RBLOCK: tl.constexpr
):
    """Compute argmax over a dimension using block-wise reduction."""
    ...
    outptr_index = (
        tl.arange(0, XBLOCK)[:, None] + tl.zeros((RBLOCK,), tl.int32)[None, :]
    )
...
def call():
    """Test function for argmax kernel."""
